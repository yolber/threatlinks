...
function draw_graph() {
  ...
  var fileName = fileLoc + type + clas + date + time + '.json';
  ...
  $.ajax({
    ...
    error: function()
    {
        ...
        fileName = fileLoc + type + clas + date +'.json';
        ...
        $.ajax({
          ...
          {
            console.log('The file: ' + fileName +' does not exist');
            fileName = fileLoc + type + clas + date + time + '.gexf';
            ...
            $.ajax({
              ...
              error: function(){
                console.log('The file: ' + fileName +' does not exist');
                fileName = fileLoc + clas + type + date +'.gexf';
                console.log('Trying file name: ' + fileName);
                $.ajax({
                  url: fileName,
                  type: 'HEAD',
                  error: function(){
                    if (clas != "ForbiddenBigrams") {
                      ...
                      console.log('The file: ' + fileName +' does not exist');
                      fileName = fileLoc + "nx" + date + time +'.gexf';
                      console.log('Trying file name: ' + fileName);
                      $.ajax({
                        url: fileName,
                        type: 'HEAD',
