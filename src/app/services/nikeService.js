class NikeService {
  constructor($http) {
    this.$http = $http;
    //this.prefix = window.location.hostname.match(/threatview-as/) ? '/t/visualization' : '//threatview-as.labs.hpecorp.net:8090/t/visualization';
...
NikeService.$inject = ['$http'];

export default NikeService;
